...
class InfoPage(tk.Frame):
    ...
    def generateUniqueIDInt(self):
            ...
            # The ID is generated by taking the length of the list of users and adding 1
            # This way, each user has a unique ID
    ...
    def create_order_table(self):
        self.clothes_table = ttk.Treeview(self, columns=("Cloth", "Laundry", "Total Price"), show="headings")
    ...
    def update_order_table(self):
        ...
        for cloth, laundry, price in self.clothes:
            total_price += price
            self.clothes_table.insert("", "end", values=(cloth, laundry, price))
    ...
    def confirm_order(self):
        ...
        if name and phone and email:
            ...
            self.controller.frames["AdminPage"].display_order_information(name, phone, email, self.clothes, total_price)
